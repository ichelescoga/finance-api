...
const auto = new SequelizeAuto('Anticipo', 'dbmasteruser', 'C0NV+y~i*:vo;b_!77P*l!7.mi+Z6(r+', {
  ...
  directory: path.join(__dirname, 'src/modelsA'), // directorio donde se generarán los modelos
  additional: {
